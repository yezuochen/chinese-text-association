...
- **No preprocessing guardrails.** Empty stubs and the 3.5 MB outlier file pass through unchanged — this is intentional (see MEMO §2 / §10). Do not add length filters without flagging the change.
